        ...
        <div class="col-70">
            <div class="box-banner">
                ...
                <div class="small-update th">
                    <a class="banner-text" href="">Acer</a>
            ...
            <div class="box-banner">
                <button class="button">Laptop cấu hình</button>
                <div class="small-update ch">
                    <a href="">Inter core i3</a>
                    <a href="">Inter core i5</a>
                    <a href="">Inter core i7</a>
            ...
            <div class="box-banner">
                <button class="button">Laptop theo giá</button>
    ...
    <div class="main">
        ...
        <div class="box-all">
            ...
            <div class="sp-laptop">
                <div class="sp-one">
                    <a href="index.php?act=sanphamct"><img src="./views/imgs/asus1.jpg" alt="" /></a>
                    <div class="text-sp">
                        <legend>ASUS</legend>
                        <p>
